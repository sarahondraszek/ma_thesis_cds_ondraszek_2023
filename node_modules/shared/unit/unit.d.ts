...
module testtracker {
    function illegaltype(test): void;
    function objctor(test): void;
    function idobjctor(test): void;
    function arrayctor(test): void;
    function idarrayctor(test): void;
    function rev(test): void;
    function wrapNumber(test): void;
    function wrapString(test): void;
    function wrapBoolean(test): void;
    function wrapFunc(test): void;
    function wrapObj(test): void;
    function wrapArray(test): void;
    function cycleTypes(test): void;
    function unwrapable(test): void;
    function nonenum(test): void;
    function deleteable(test): void;
    function arrreverse(test): void;
    function arrsort(test): void;
    function arrshift(test): void;
    function pushNumberProp(test): void;
    function pushBoolProp(test): void;
    function pushStringProp(test): void;
    function pushOtherProp(test): void;
    function pushObjectProp(test): void;
    function pushRecuObjectProp(test): void;
    function pushArrayProp(test): void;
    function pushRecuArrayProp(test): void;
    function readsetArray(test): void;
    function readsetObject(test): void;
    function writesetArray1(test): void;
    function writesetArray2(test): void;
    function delObject(test): void;
    function delArray(test): void;
    function reverse(test): void;
    function sort(test): void;
    function xstore(test): void;
    function spliceDel(test): void;
    function spliceIns(test): void;
    function sparseArray(test): void;
}
module testutils {
    function clog_empty(test): void;
    function clog_debug_one_subject(test): void;
    function clog_debug_two_subject(test): void;
    function clog_no_debug(test): void;
    function clog_warn(test): void;
    function clog_fatal(test): void;
    function hashString(test): void;
    function isvalue(test): void;
    function isobject(test): void;
    function typetest(test): void;
    function unique(test): void;
    function stringmap(test): void;
    function stringset(test): void;
    function mapapply(test): void;
}
module testtypes {
    function equality(test): void;
    function directequality(test): void;
    function isobjarray(test): void;
    function props(test): void;
}
module testserial {
    function writeValue(test);
    function writeObject(test): void;
    function writeObjectId(test): void;
    function readValue(test): void;
    function readObject(test): void;
    function scaleNumber(test): void;
}
module testundo {
    function newProps(test): void;
    function changePropsNumber(test): void;
    function changePropsNull(test): void;
    function changePropsUndefined(test): void;
    function changePropsString(test): void;
    function changePropsDate(test): void;
    function changePropsFunction(test): void;
    function changePropsObject(test): void;
    function changePropsArray(test): void;
    function deleteProp(test): void;
    function deleteNestedProp(test): void;
    function deleteNestedProp2(test): void;
    function newArrayProps(test): void;
    function changeArrayProps(test): void;
    function deleteArrayProps(test): void;
    function arrayPush(test): void;
    function arrayPop(test): void;
    function arrayShift(test): void;
    function arrayUnShift(test): void;
    function arraySort(test): void;
    function arrayReverse(test): void;
    function arraySplice1(test): void;
    function arraySplice2(test): void;
    function arraySplice3(test): void;
}
module testcommit {
    function create(test): void;
    function emptyCommit(test): void;
    function simpleAssignNumber(test): void;
    function simpleAssignNumber2(test): void;
    function simpleAssignString(test): void;
    function simpleAssignBool(test): void;
    function simpleAssignNull(test): void;
    function simpleAssignUndefined(test): void;
    function simpleAssignObject(test): void;
    function simpleAssignArray(test): void;
    function simpleAssignNestedObject(test): void;
    function simpleAssignNestedArray(test): void;
    function assignOverwrite(test): void;
    function assignNested(test): void;
    function assignNested2(test): void;
    function delProp(test): void;
    function delNested(test): void;
    function delDoubleNested(test): void;
    function arrayDel(test): void;
    function arraySort(test): void;
    function arrayReverse(test): void;
    function arrayShift1(test): void;
    function arrayShift2(test): void;
    function arrayShift3(test): void;
    function arrayUnShift1(test): void;
    function arrayUnShift2(test): void;
    function arrayUnShift3(test): void;
    function arraySplice(test): void;
    function wrappedPush(test): void;
}
